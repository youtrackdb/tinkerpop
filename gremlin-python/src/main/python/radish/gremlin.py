...
world.gremlins = {
    ...
    'g_withSideEffectXa_setX_V_both_name_aggregateXlocal_aX_capXaX': [(lambda g:g.with_side_effect('a', {}).V().both().values('name').aggregate(Scope.local, 'a').cap('a'))], 
    ...
    'g_withSideEffectXa_setX_V_both_name_storeXaX_capXaX': [(lambda g:g.with_side_effect('a', {}).V().both().values('name').store('a').cap('a'))], 
