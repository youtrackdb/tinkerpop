...
world.gremlins = {
    ...
    'g_E': [(lambda g:g.E()), (lambda g:g.E())], 
    'g_EX11X': [(lambda g, eid11=None:g.E(eid11)), (lambda g, eid11=None:g.E(eid11))], 
    'g_EX11AsStringX': [(lambda g, eid11=None:g.E(eid11)), (lambda g, eid11=None:g.E(eid11))], 
    'g_EXe11X': [(lambda g, e11=None:g.E(e11)), (lambda g, e11=None:g.E(e11))], 
    'g_EXe7_e11X': [(lambda g, e7=None,e11=None:g.E(e7, e11)), (lambda g, e7=None,e11=None:g.E(e7, e11))], 
    'g_EXlistXe7_e11XX': [(lambda g, xx1=None:g.E(xx1)), (lambda g, xx1=None:g.E(xx1))], 
    'g_EXnullX': [(lambda g:g.E(None)), (lambda g:g.E(None))], 
    'g_EXlistXnullXX': [(lambda g, xx1=None:g.E(xx1)), (lambda g, xx1=None:g.E(xx1))], 
    'g_EX11_nullX': [(lambda g, eid11=None:g.E(eid11, None)), (lambda g, eid11=None:g.E(eid11, None))], 
    ...
    'g_V_mergeE_inlineXemptyX_optionXonCreate_nullX': [(lambda g:g.add_v('person').property('name', 'marko').property('age', 29)), (lambda g:g.V().as_('v').merge_e({ T.label: 'self', 'OUT': Merge.out_v, 'IN': Merge.in_v }).option(Merge.on_create, None).option(Merge.out_v, __.select('v')).option(Merge.in_v, __.select('v'))), (lambda g:g.E()), (lambda g:g.V())], 
    ...
    'g_V_mergeE_inlineXemptyX_two_exist': [(lambda g:g.add_v('person').property('name', 'marko').property('age', 29).add_v('person').property('name', 'vadas').property('age', 27)), (lambda g:g.V().as_('v').merge_e({ T.label: 'self', 'OUT': Merge.out_v, 'IN': Merge.in_v }).option(Merge.out_v, __.select('v')).option(Merge.in_v, __.select('v'))), (lambda g:g.E()), (lambda g:g.V())], 
    ...
    'g_mergeE_inline_with_outVinV_options_map': [(lambda g, xx1=None,xx2=None:g.add_v('person').property('name', 'marko').add_v('person').property('name', 'vadas')), (lambda g, xx1=None,xx2=None:g.merge_e({ 'OUT': Merge.out_v, 'IN': Merge.in_v, T.label: 'knows' }).option(Merge.out_v, xx1).option(Merge.in_v, xx2)), (lambda g, xx1=None,xx2=None:g.V()), (lambda g, xx1=None,xx2=None:g.V().has('name', 'marko').out('knows').has('name', 'vadas'))], 
