...
public class DefaultGremlinBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements GremlinVisitor<T> {
	 ...
	 */
	@Override
	public T visitTraversalSourceSpawnMethod_customService_empty(final GremlinParser.TraversalSourceSpawnMethod_customService_emptyContext ctx) { notImplemented(ctx); return null; }
	/**
	 * {@inheritDoc}
	 */
	@Override
	public T visitTraversalSourceSpawnMethod_customService_map(final GremlinParser.TraversalSourceSpawnMethod_customService_mapContext ctx) { notImplemented(ctx); return null; }
	/**
	 * {@inheritDoc}
	 */
	@Override
	public T visitTraversalSourceSpawnMethod_customService_traversal(final GremlinParser.TraversalSourceSpawnMethod_customService_traversalContext ctx) { notImplemented(ctx); return null; }
	/**
	 * {@inheritDoc}
	 */
	@Override
	public T visitTraversalSourceSpawnMethod_customService_map_traversal(final GremlinParser.TraversalSourceSpawnMethod_customService_map_traversalContext ctx) { notImplemented(ctx); return null; }
	/**
	 * {@inheritDoc}
	 */
	@Override
	 ...
	 * {@inheritDoc}
	 */
	@Override public T visitTraversalMethod_customService_empty(final GremlinParser.TraversalMethod_customService_emptyContext ctx) { notImplemented(ctx); return null; }
	/**
	 * {@inheritDoc}
	 */
	@Override public T visitTraversalMethod_customService_map(final GremlinParser.TraversalMethod_customService_mapContext ctx) { notImplemented(ctx); return null; }
	/**
	 * {@inheritDoc}
	 */
	@Override public T visitTraversalMethod_customService_traversal(final GremlinParser.TraversalMethod_customService_traversalContext ctx) { notImplemented(ctx); return null; }
	/**
	 * {@inheritDoc}
	 */
	 ...
	 * {@inheritDoc}
	 */
	@Override public T visitTraversalMethod_format_String(final GremlinParser.TraversalMethod_format_StringContext ctx) { notImplemented(ctx); return null; }
	/**
	 * {@inheritDoc}
	 */
	 ...
	 * {@inheritDoc}
	 */
	@Override public T visitGenericArgumentVarargs(final GremlinParser.GenericArgumentVarargsContext ctx) { notImplemented(ctx); return null; }
	/**
	 * {@inheritDoc}
	 */
